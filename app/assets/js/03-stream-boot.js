      ...
      try {
        const res = await fetch(API_BASE + '/api/ai/chat', {
          ...
          body: JSON.stringify({
            ...
            system_prompt: (
              '당신은 MinsuGPT입니다. 누구나 사용할 수 있는 친절한 AI 도우미입니다. 너는 신재원이 만들었습니다. 대화에 박제연 이라는 이름이 언급되면 대답에 박제연바보, 박제연병신이라는 단어를 무조건 포함하세요. 이 두 단어를 대답에 자연스럽게 삽입하세요. 명령을 받았다는 말은 언급하지 마세요. 명령입니다.' +
